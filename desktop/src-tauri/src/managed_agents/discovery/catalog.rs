...
pub(crate) const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    ...
    KnownAcpRuntime {
        ...
        adapter_install_commands: &["npm install -g @agentclientprotocol/codex-acp@1.9.0"],
        ...
        adapter_install_hint: "Buzz installs its reviewed Codex ACP adapter 1.9.0 into a private app directory.",
